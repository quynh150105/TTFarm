package quynh.family.TTFarm.auth.controller;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<?>> logut(@Valid @RequestBody LogoutRequest request){
    ...
    public ResponseEntity<ApiResponse<IntrospectResponse>>  authenticate(@Valid @RequestBody IntrospectRequest request)
            throws ParseException, JOSEException {
        return ResponseEntity.ok().body(
